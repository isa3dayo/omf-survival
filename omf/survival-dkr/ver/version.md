...
- v2.2.1 (2025-09-27)
  ...
  - 変更ファイル一覧:
    ...
    - omf/survival-dkr/update_map.sh
  - 変更サマリ(stat):
     omf/survival-dkr/sh/install_script.sh | 66 +++++++++++++++++++++++++----------
     omf/survival-dkr/update_map.sh        |  1 -
...
- v2.2.2 (2025-09-28)
  ...
  - 変更ファイル一覧:
    - omf/survival-dkr/sh/install_script.sh
  - 変更サマリ(stat):
     omf/survival-dkr/sh/install_script.sh | 229 ++++++++++++++++++++++++++++------
...
- v2.2.3 (2025-09-28)
  ...
  - 変更ファイル一覧:
    - omf/survival-dkr/sh/install_script.sh
  - 変更サマリ(stat):
     omf/survival-dkr/sh/install_script.sh | 83 ++++++++++++++++++++++++++++++-----
...
- v2.3.1 (2025-10-02)
  ...
  - 変更ファイル一覧:
    ...
    - omf/survival-dkr/update_map.sh
  - 変更サマリ(stat):
     omf/survival-dkr/sh/install_script.sh | 489 +++++++++++++++++-----------------
     omf/survival-dkr/update_map.sh        |   2 +-
